...
function Login() {
  ...
  const onClickLogin = async () =>  {
    if(inputValidation()){
      const response = await LogIn(LoginText.current.value, LoginPassword.current.value);
      if(response){
  ...
  return (
    <>
      ...
      <div className="LoginContainer">
        ...
        <input placeholder="Correo" ref={LoginText} className="inputLoginMenu"></input>
        {errorEmail === true ? (
        ...
        <input placeholder="Contraseña" ref={LoginPassword} className="inputLoginMenu"></input>
        {errorPassword=== true ? (
