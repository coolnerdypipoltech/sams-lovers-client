  ...
  return (
    <>
      ...
      <div className="subPageContainer">
        ...
        >
          <div  style={{ maxWidth: "1000px", display: "flex", flexFlow: "column" }}>
            ...
            <p className="challenge-text2">{reward.description}</p>
            <div className="informationRewardPageContainer">
              ...
              <div className="challenge-information-container">
                ...
                <div className="diamondsContainer">
                  ...
                  >
                    {`Vigencia del ${returnDayAndMonth(
                      reward.starts_on
                    )} al ${returnDayAndMonth(reward.ends_on)} del ${returnYear(
                      reward.ends_on
                    )}`}
                  </p>
                </div>
              ...
              <RewardInfoBox
                ...
                ammount={
                  reward.total_user_transactions_left > 0
                    ? reward.total_user_transactions_left
                    : "Agotado"
                }
                icon={canje}
                toolTipText={
            ...
            <div
              ...
              className="rowAlign"
            >
              <p className="challenge-information-text-conditions">
                Condiciones
              </p>
              <img
                src={chevronRight}
        ...
        <>
          ...
          <div className="participationContainer">
            <button
              style={{ width: "80%", maxWidth: "800px", fontSize: "15px" }}
              className={
                isButtonActive() ? "GeneralButton4" : "GeneralButton4-Inactive"
              }
